      ...
      <div class="swiper-slide">
        <div class="card">
          <div class="swiper mySwiper" id="swiper-${o}" style="position: relative;">
            <div class="card-tag" style="background-color: ${a};">${e.tipoTransaccion}</div>
