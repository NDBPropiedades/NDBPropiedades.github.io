...
function crearCardHTML(e,o){let a;return `
    ...
    `}
function cargarPropiedades(e){let o=(paginaActual-1)*9;e.slice(o,o+9).forEach((e,o)=>{let a=crearCardHTML(e,o);contenedorPropiedades.insertAdjacentHTML("beforeend",a)}),inicializarSwipers()}
function inicializarSwipers(){document.querySelectorAll(".mySwiper").forEach((e)=>{e.swiper||new Swiper(e,{loop:!0,pagination:{el:e.querySelector(".swiper-pagination"),clickable:!0,},autoplay:{delay:4e3,disableOnInteraction:!1},navigation:{nextEl:e.querySelector(".swiper-button-next"),prevEl:e.querySelector(".swiper-button-prev"),},})})}
